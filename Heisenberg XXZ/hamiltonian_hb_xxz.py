    ...
    for state_index, state in enumerate(basis_states):
        ...
        for bond in heisenberg_bonds:
            ...
            if get_site_value(state, bond[0]) != get_site_value(state, bond[1]):
                ...
                representative, translation = get_representative(L, new_state) # This is L^2!!!
                new_state_index = basis_states.index(representative) # Depending on the implementation this is slow!
